...
export default function Index() {
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-link {
          font-size: .78rem; font-weight: 500; color: #777; text-decoration: none;
        ...
        .nav-cta {
          font-size: .78rem; font-weight: 400; color: #fff; background: #111;
          border-radius: 3px; padding: 7px 15px; text-decoration: none;
          display: inline-flex; align-items: center; gap: 5px;
          transition: background .15s, transform .15s, box-shadow .15s;
          margin-left: 6px; box-shadow: 0 2px 8px rgba(0,0,0,.15);
        }
        .nav-cta:hover { background: #222; transform: translateY(-1px); box-shadow: 0 4px 16px rgba(0,0,0,.2); }
        ...
        .hero-glow {
          ...
          width: 600px; height: 480px; pointer-events: none; z-index: 0;
          background: radial-gradient(ellipse at center, rgba(0,0,0,.025) 0%, transparent 70%);
        }
        .hero-corner-tl, .hero-corner-tr, .hero-corner-bl, .hero-corner-br {
          position: absolute; width: 56px; height: 56px; pointer-events: none; z-index: 1;
        }
        ...
        .hero-label {
          ...
          letter-spacing: .1em; color: #888; margin-bottom: 28px;
          border: 1px solid #e0e0e0; padding: 4px 12px; border-radius: 999px;
        ...
        .btn-d {
          font-size: .8rem; font-weight: 400; color: #fff; background: #111;
        ...
        .btn-d:hover { background: #1a1a1a; transform: translateY(-1px); box-shadow: 0 6px 20px rgba(0,0,0,.22), inset 0 1px 0 rgba(255,255,255,.1); }
        .btn-d svg { transition: transform .18s; }
        .btn-d:hover svg { transform: translateX(2px); }
        .btn-l {
          font-size: .8rem; font-weight: 400; color: #555;
          background: #f7f7f7; padding: 10px 18px; border-radius: 4px;
          text-decoration: none; display: inline-flex; align-items: center; gap: 6px;
          border: 1px solid #e4e4e4;
          transition: background .15s, border-color .15s, color .15s, transform .15s;
        }
        .btn-l:hover { background: #efefef; border-color: #d8d8d8; color: #111; transform: translateY(-1px); }
        ...
        .hhl {
          ...
          gap: 7px; padding: 16px 24px; border-right: 1px solid #e8e8e8;
        }
        .hhl:last-child { border-right: none; }
        .hhl-text { font-size: .8rem; font-weight: 600; color: #333; letter-spacing: -.01em; white-space: nowrap; }

        /* ── MARQUEE ── */
        .hero-mqw {
          width: 100%; overflow: hidden;
          padding: 15px 0; background: #fafafa;
        ...
        .feat-card {
          ...
          transition: background .18s; display: flex; flex-direction: column; gap: 10px;
        ...
        .step-card {
          background: #fff; border: 1px solid #e8e8e8; border-radius: 14px; padding: 28px 22px;
        ...
        .step-title { font-size: .875rem; font-weight: 700; color: #111; margin-bottom: 6px; letter-spacing: -.02em; }
        .step-desc { font-size: .82rem; color: #888; line-height: 1.65; }

        /* ── CTA ── */
        .cta-sec { padding: 88px 0; }
        .cta-box {
          background: #111; border-radius: 20px; padding: 72px 56px;
          display: flex; align-items: center; justify-content: space-between;
        ...
        .cta-btn-p {
          font-size: .8rem; font-weight: 400; color: #111; background: #fff;
          padding: 10px 20px; border-radius: 4px; text-decoration: none;
          display: inline-flex; align-items: center; gap: 6px;
          border: 1.5px solid #fff; box-shadow: 0 2px 12px rgba(0,0,0,.2);
          transition: background .15s, transform .15s, box-shadow .15s;
          white-space: nowrap; letter-spacing: -.01em;
        }
        .cta-btn-p:hover { background: #f0f0f0; transform: translateY(-1px); box-shadow: 0 6px 20px rgba(0,0,0,.25); }
        .cta-btn-p svg { transition: transform .18s; }
        .cta-btn-p:hover svg { transform: translateX(2px); }
        .cta-btn-g {
          font-size: .8rem; font-weight: 400; color: rgba(255,255,255,.5);
          background: transparent; padding: 10px 16px; border-radius: 4px;
          text-decoration: none; display: inline-flex; align-items: center; gap: 6px;
          border: 1.5px solid rgba(255,255,255,.14);
          transition: border-color .15s, color .15s, background .15s; white-space: nowrap;
        }
        .cta-btn-g:hover { border-color: rgba(255,255,255,.3); color: rgba(255,255,255,.85); background: rgba(255,255,255,.04); }
        ...
        .footer-links a { font-size: .7rem; color: #bbb; text-decoration: none; transition: color .15s; }
        ...
        @media(max-width:600px) {
          ...
          /* Center links — mobile-এ লুকাও */
          .nav-center { display: none; }

          /* nav-link text লুকাও, icon দেখাও */
          .nav-link-text { display: none; }

          .hero { padding-top: 106px; min-height: 90vh; }
          .hero-content { padding: 0 20px 40px; }
          .hero-corner-tl,.hero-corner-tr { top: 62px; width: 40px; height: 40px; }
  ...
  font-family: 'Siliguri', 'Manrope', sans-serif;
          ...
          .hhl { border-right: none; border-bottom: 1px solid #e8e8e8; padding: 13px 20px; }
          ...
          .cta-box { padding: 36px 22px; flex-direction: column; align-items: flex-start; gap: 28px; border-radius: 16px; }
          .cta-r { width: 100%; }
          .cta-sub { max-width: 100%; }
          .cta-btns { width: 100%; flex-direction: column; gap: 8px; }
          .cta-btn-p, .cta-btn-g { justify-content: center; }

          .footer { padding: 20px 16px; }
          .footer-links { display: none; }

          /* mobile nav-cta — icon only */
      ...
      <div className="pg">
        ...
        >
          ...
          {/* Center — Features & Process, desktop only */}
          ...
          <div className="nav-right">
            <Link to="/find-ticket" className="nav-link">
              <Search size={15} />
              <span className="nav-link-text">Find Ticket</span>
            </Link>
            {user ? (
              <Link to="/dashboard" className="nav-cta" title="Dashboard">
                <ChevronLast size={14} />
                <span className="nav-cta-text">Dashboard</span>
              </Link>
            ) : (
          ...
          <div className="wrap">
            <div className="sec-head gf">
              <div className="eyebrow">
                <CornerBox color="#0000FF">Features</CornerBox>
              </div>
        ...
        <section className="steps-bg sec" id="process">
          <div className="wrap">
            <div className="sec-head gf">
              <div className="eyebrow">
                <CornerBox color="#008000">How it works</CornerBox>
              </div>
              <h2 className="sec-title">
                Three steps
                <br />
            ...
            <div className="cta-box">
              ...
              <div className="cta-r">
                ...
                <div className="cta-btns">
                  <Link to="/auth" className="cta-btn-p">
        ...
        <footer className="footer">
          <div className="footer-in">
            ...
            <div>
              <div className="footer-copy text-end">{footerText}</div>
              <div className="footer-copy text-end">
                Created with ❤️ by
                <a
